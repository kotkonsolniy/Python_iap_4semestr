...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('scanner.log'),  # Логи в файл
...
if __name__ == '__main__':
    ...
    parser.add_argument('--host', type=str, default='192.168.119.176', help='Host to scan from')
    parser.add_argument('--subnet', type=str, default='192.168.119.0/24', help='Subnet to scan')
